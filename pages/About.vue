    ...
    <b-row>
      <b-col col class="mb-6">
        ...
        <p>
          ...
          populates the SSID and password fields from the data recieved from the
          ESP32 device. You can then edit the desired fields, and then press the
          "Configure device" button to send the new configuration to the ESP32.
          ...
          device when needed. Once done with the configuration, click
          "Disconnect", and the stored SSIDs and credentials will be saved in
