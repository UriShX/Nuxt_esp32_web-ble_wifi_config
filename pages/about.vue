<template>
  <b-container fluid>
    <b-card no-body>
      ...
      <b-card-body id="reltive-pos" ref="content">
        ...
        <p id="about-3">
          ...
          enable easier implementation as part of larger web applications, such
          as, for eg., a web site which enables the connection of devices to
          database for downloading and uploading data measured by the device.<br />
        ...
        <p id="usage-0">
          ...
          for Bluetooth-LE devices with a name that starts with "ESP32", and has
          a predefined service UUID. Select the desired device from the device
          selection menu, and press "Pair".<br />
          ...
          The app then requests for both a list of SSIDs seen by the device, as
          well as the connection status of the device - whether it is connected
          to the first defined AP, the second, or none of them.<br />
          <i>
        ...
        <ul id="usage-1">
          ...
          <li>
            A status box is displayed above the form fields. In it, the current
            WiFi connection status of the ESP32 device to which the app is
            connected. (If supported by the device).
          </li>
          <li>
            On the right side of the connection status box is a "Refresh"
            button. Pressing this button will ask the device for the
            configuration currently stored on it, and will therefore delete any
        ...
        <p id="usage-2">
          ...
          configured SSIDs and associated passwords, and "Reset" - to reset the
          device when needed.<br />
